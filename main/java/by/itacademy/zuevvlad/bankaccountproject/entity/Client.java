package by.itacademy.zuevvlad.bankaccountproject.entity;
...
public final class Client extends Entity
{
    ...
    public Client(final long id, final String name, final String surname, final String patronymic,
                  final String phoneNumber, final BankAccount bankAccount)
    {
        super(id);
